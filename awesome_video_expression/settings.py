"""
Django settings for awesome_video_expression project.
...
MODEL_FER2013_WEIGHT = os.path.join(BASE_DIR, env('MODEL_FER2013_WEIGHT'))

NB_STEP_FRAME  = int(env('NB_STEP_FRAME'))

ROOT_URLCONF = 'awesome_video_expression.urls'
...
WSGI_APPLICATION = 'awesome_video_expression.wsgi.application'
