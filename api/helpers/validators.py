...
from .constants import (VIDEO_EXTENSIONS, VIDEO_MAX_SIZE, VIDEO_MIME_TYPES)
...
video_validator = UploadedFileValidator(allowed_extensions=VIDEO_EXTENSIONS,
                                        allowed_mimetypes=VIDEO_MIME_TYPES,
